...
public class GiurisprudenzaLandingFragment extends Fragment {
    ...
    public static GiurisprudenzaLandingFragment newInstance() {
        return new GiurisprudenzaLandingFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new GiurisprudenzaFragmentAdapter(getChildFragmentManager());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_website) {
            Uri uri = Uri.parse(URLS.GIURISPRUDENZA);
